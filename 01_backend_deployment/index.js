...
app.get("/linkedin", (req, res) => {
  res.send("<a href='https://www.linkedin.com/in/mukulpadwal'>Mukul Padwal</a>");
});
...
res.json({
  ...
  "following_url": "https://api.github.com/users/mukulpadwal/following{/other_user}",
  "gists_url": "https://api.github.com/users/mukulpadwal/gists{/gist_id}",
  "starred_url": "https://api.github.com/users/mukulpadwal/starred{/owner}{/repo}",
  ...
  "received_events_url": "https://api.github.com/users/mukulpadwal/received_events",
  "type": "User",
  "site_admin": false,
  "name": "Mukul Padwal",
  "company": null,
